...
const TASK_NAME_USER: &str = "Clash Verge Next";
const TASK_NAME_ADMIN: &str = "Clash Verge Next (Admin)";
const TASK_XML_DIR: &str = "tasks";
const TASK_XML_USER: &str = "clash-verge-next-task-user.xml";
const TASK_XML_ADMIN: &str = "clash-verge-next-task-admin.xml";
...
async fn cleanup_legacy_shortcuts() -> Result<()> {
    ...
    let old_shortcut = startup_dir.join("Clash-Verge-Next.lnk");
    let new_shortcut = startup_dir.join("Clash Verge Next.lnk");
