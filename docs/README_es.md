...
Visita la [página de lanzamientos](https://github.com/Lochinemak/clash-verge-rev/releases) y descarga el instalador que corresponda a tu plataforma.<br>
...
| :---------- | :----------------------------------------------------------------------------- | :------------------------------------------------------------------------------------- |
| Stable      | Compilaciones oficiales de alta fiabilidad; ideales para el uso diario.        | [Release](https://github.com/Lochinemak/clash-verge-rev/releases)                 |
| Alpha (EOL) | Compilaciones heredadas usadas para validar el flujo de publicación.           | [Alpha](https://github.com/Lochinemak/clash-verge-rev/releases/tag/alpha)         |
| AutoBuild   | Compilaciones continuas para pruebas y retroalimentación. Espera cambios beta. | [AutoBuild](https://github.com/Lochinemak/clash-verge-rev/releases/tag/autobuild) |
